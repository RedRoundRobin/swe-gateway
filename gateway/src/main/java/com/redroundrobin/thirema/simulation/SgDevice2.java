...
public class SgDevice2 {
    ...
    public static void main(String[] args) {
        ...
        List<Sensor> sensors1 = new ArrayList<>(Arrays.asList(
                ...
                new Sensor(2, 120),
                new Sensor(3, 120)));
        Device device1 = new Device(3, sensors1);

        List<Sensor> sensors2 = new ArrayList<>(Arrays.asList(
                new Sensor(1, 20),
                new Sensor(2, 20)));
        Device device2 = new Device(4, sensors2);

        List<Sensor> sensors3 = new ArrayList<>(Arrays.asList(
                new Sensor(1, 120),
                new Sensor(2, 120)));
        Device device3 = new Device(69, sensors3);

        List<Device> devices = new ArrayList<>(Arrays.asList(device1, device2, device3));
